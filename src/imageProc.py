...
class imageProc(object):
	...
	def __init__(self):
		...
		(self.x_topCorner_CORRENTE, self.y_topCorner_CORRENTE,self.x_botCorner_CORRENTE, self.y_botCorner_CORRENTE) = (260,210,440,240)
